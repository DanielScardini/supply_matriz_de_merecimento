...
def carregar_matrizes_merecimento_calculadas() -> Dict[str, DataFrame]:
    ...
    for categoria in categorias:
        try:
            nome_tabela = f"databox.bcg_comum.supply_matriz_merecimento_telefonia_celular_online_teste2410"
...
df_merecimento_online['TELEFONIA_CELULAR'] = carregar_matrizes_merecimento_calculadas()['TELEFONIA_CELULAR']

df_merecimento_online['TELEFONIA_CELULAR'].limit(1).display()
...
df_matriz_neogrid_agg_online.limit(1).display()
